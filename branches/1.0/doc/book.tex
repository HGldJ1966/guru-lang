...
\texttt{guru-lang/lib/vec.g}.  In the first line, we declare
\texttt{vec} to be a type constructor, similarly to the declaration we
have in Section~\ref{ch6:lists} for \texttt{list}.  Here we see that
\texttt{vec}'s classifier (its \emph{kind}) is
