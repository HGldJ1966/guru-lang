...
Define primitive type_family_abbrev uwarray := fun(A:type)(n:word).<vec A (to_nat wordlen n)> <<END
...
Define primitive uwarray_get
  ...
  fun(A:type)(spec n:word)(l:<uwarray A n>)(i:word)(u:{(lt (to_nat i) (to_nat n)) = tt}). 
...
Define primitive uwarray_set 
  : Fun(A:type)(i:word)(#untracked a:A)(spec n:word)(#unique l:<uwarray A n>)
       (u:{(lt (to_nat i) (to_nat n)) = tt}). #unique <uwarray A n> :=
  fun(A:type)(i:word)(a:A)(spec n:word)(l:<uwarray A n>)(u:{(lt (to_nat i) (to_nat n)) = tt}).
...
Define primitive uwarray_free : Fun(A:type)(n:word)(^ #unique l:<uwarray A n>).void :=
  fun(A:type)(n:word)(l:<uwarray A n>).voidi <<END
