...
\texttt{ff} for that number).  Test your function with the following.
Here, \texttt{eqnat} is a function, defined in \texttt{nat.g}, which
takes two \texttt{nat}s as input and returns \texttt{tt} if they are
equal, and \texttt{ff} otherwise).  Also, \texttt{nine} is defined in
